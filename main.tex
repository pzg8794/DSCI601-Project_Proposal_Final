...
\modified{The preliminary results are organized around the research questions stated in
...
EQUITAS must preserve while reducing service disparities. The evidence-source
summary for these inherited quantum results is provided in
Appendix~\ref{app:quantum_prelim_evidence}; the main text keeps the numerical
context-spectrum results and figure in the results flow.}
...
\modified{The clinical side contributes preliminary evidence from the EQUITAS
...
Appendix~\ref{app:equitas_bioinformatics_evidence} reports the detailed
evidence-source table; the main results focus on the quantitative pattern and
its connection to the routing method.}
...
\modified{Together, the preliminary findings support the central novelty of the method.
...
\section{Conclusion}
\modified{This semester established the foundation for a reproducible fairness-aware
